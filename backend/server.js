...
const seedDatabase = async () => {
  try {
    ...
    if (!adminUser) {
      ...
      console.log(
        "Varun admin credentials created: varun2004.pvt@gmail.com / admin123",
      );
...
const connectDB = async () => {
  const MONGO_URI =
    process.env.MONGO_URI || "mongodb://localhost:27017/onwheel-ev";
  ...
  try {
    ...
    console.log(
      "The backend server will run in-memory. Data modifications will persist during this server run, but will reset upon server restart.",
    );
